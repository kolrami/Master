...
Consider figure \ref{fig:selfadapt}, visualizing the self-adaption idea by
...
\begin{figure}
	\centering
	\includegraphics{../figures/selfadapt}
...
requiring a short response time and a faster scan rate.
