...
position, multiple measurements are performed in a single scan cycle and are
smoothed by applying a median average.
...
\begin{figure}
	...
	\caption{Extended structure of the demonstrator \todo{saw thread}}
