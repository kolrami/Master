...
Figure \ref{fig:pid_rep} \todo{fix wrong PD in controller figure} illustrates
the concept of a \ac{PID} controller with regard to the Ball on Plate
application as the process of the control loop.
\begin{figure}
	\centering
	\centering
