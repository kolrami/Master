...
out of high-level languages like C \citep{SWL13}. Having a common description
for both software and hardware implementations offers even more possibilities.
Due to the transparency of hardware and software implementations, a thread
might be migrated from software to hardware or vice versa. Self-adaptiveness
allows the system to reconfigure itself based on the current needs to reduce
power or increase performance.
