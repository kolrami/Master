...
\begin{figure}
	...
	\label{fig:img_proc}
\end{figure}It consist out of two filter threads, the first one
...
processing time for a single image of 128x205 pixels. They are measured
...
$\SI{24.44}{\milli\second}$. The communication involving the processor slows
down the system dramatically, especially the transfer of data via the
