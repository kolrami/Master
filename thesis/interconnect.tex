...
discussed in the next section, allows to simplify the interface to the
...
kernel driver and system bus supports only sequential access, the parallel
...
hard- or software and which threads are currently running. Generally, the
software interface should always act as a fallback and, therefore, be able to
address all resources of the system.
