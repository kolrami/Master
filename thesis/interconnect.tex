...
thread execution modes and processor loads.
\begin{table}
	\centering
	...
	\hline
	Hardware & Low & ? & ? & ? & ?\\
	Hardware & High & 6146 & 7 & 10924 & 1543\\
	Software & Low & ? & ? & ? & ?\\
	Software & High & 3091 & 7857 & 1140 & 3778\\
	\hline
	\end{tabular}
\end{table}
...
threads, executing arbitrary operations and communicating frequently.

Independent from the system load, the hardware resource outperforms its
software counterparts for communication between hardware threads by providing
low-latency access without any jitter. However, for communication involving
software threads, it ...
