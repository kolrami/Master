...
\end{lstlisting}
The four
streaming parameters \lstinline{osif_sw2hw}, \lstinline{osif_hw2sw},
...
\begin{itemize}
\item Difference between OSFSM and processing logic
\item External interfaces of hardware thread only FIFO based
\item No integration of external VHDL packages
\item Implementation of ReconOS package in HLS
\item 
\end{itemize}
